...
const ResultPage: React.FC<ResultPageProps> = () => {
  ...
  const { groupedRLatLons, placeType } = location.state as { groupedRLatLons: GroupedRLatLon[], placeType: PlaceType, placeName: string };
      ...
      const dataToSave = groupedRLatLons.flatMap(group =>
        group.ranLatLonss.map(ranLatLonsData => ({
          ...
          hereBasedOnGoogle: ranLatLonsData.nearbyPlaces.map(place => {
            ...
            return hereResult ? {
              ...hereResult,
              matchesGoogle: hereResult.matchesGoogle(place.formatted_address, place.name)
            } : null;
          }),
